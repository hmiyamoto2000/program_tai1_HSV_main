...
if(statistical_test == True):
    ...
    stack_1_A, stack_2_A, stack_3_A, stack_4_A, stack_5_A, stack_6_A, stack_7_A, stack_8_A,stack_9_A, stack_10_A, stack_11_A, stack_12_A, stack_13_A =\
        [],[],[],[],[],[],[],[],[],[],[],[],[]
    stack_1_B, stack_2_B, stack_3_B, stack_4_B, stack_5_B, stack_6_B, stack_7_B, stack_8_B,stack_9_B, stack_10_B, stack_11_B, stack_12_B, stack_13_B =\
        [],[],[],[],[],[],[],[],[],[],[],[],[]
    stack_1_C, stack_2_C , stack_3_C, stack_4_C, stack_5_C, stack_6_C, stack_7_C, stack_8_C,stack_9_C, stack_10_C, stack_11_C, stack_12_C, stack_13_C =\
        [],[],[],[],[],[],[],[],[],[],[],[],[]
    ...
    for sA, sB in zip(stack_A, stack_B):
        ...
        stack_11_A.append(np.sum(sA[2:136]))
        stack_12_A.append(np.sum(sA[136:176]))
        stack_13_A.append(np.sum(sA[0:180]))
        ...
        stack_11_B.append(np.sum(sA[2:136]))
        stack_12_B.append(np.sum(sA[136:176]))
        stack_13_B.append(np.sum(sA[0:180]))
    ...
    for sC in stack_C:
        ...
        stack_11_C.append(np.sum(sA[2:136]))
        stack_12_C.append(np.sum(sA[136:176]))
        stack_13_C.append(np.sum(sA[0:180]))
