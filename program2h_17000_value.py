...
if(statistical_test == True):
    ...
    stack_1_A, stack_2_A, stack_3_A, stack_4_A, stack_5_A, stack_6_A, stack_7_A =\
        [],[],[],[],[],[]
    stack_1_B, stack_2_B, stack_3_B, stack_4_B, stack_5_B, stack_6_B, stack_7_B =\
        [],[],[],[],[],[]
    stack_1_C, stack_2_C , stack_3_C, stack_4_C, stack_5_C, stack_6_C, stack_7_C =\
        [],[],[],[],[],[]
    ...
    for sA, sB in zip(stack_A, stack_B):
        ...
        stack_7_A.append(np.sum(sA[2:136]))
        ...
        stack_7_B.append(np.sum(sB[2:136]))
    ...
    for sC in stack_C:
        ...
        stack_7_C.append(np.sum(sC[2:136]))
